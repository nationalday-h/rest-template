...
public abstract class BaseFacade {
    ...
    protected <T> T strictFindByPrimaryKey(Class<T> entityClass, Object key, String... exceptionMsg) {
        ...
        if (key == null) {
            throw new com.rest.hgq.common.exceptions.NotFoundException(String.format(msg + ": null"));
        }
        T t = entityManager.find(entityClass, key);
        if (t == null) {
            throw new com.rest.hgq.common.exceptions.NotFoundException(String.format(msg + ": [%s]", key.toString()));
        }
        return t;
    }
